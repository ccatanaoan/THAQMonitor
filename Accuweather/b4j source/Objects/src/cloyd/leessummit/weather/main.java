...
public static String  _alwaysontop(anywheresoftware.b4j.objects.Form _o,boolean _boo) throws Exception{
 //BA.debugLineNum = 82;BA.debugLine="Sub AlwaysOnTop(o As Form,boo As Boolean)";
 //BA.debugLineNum = 83;BA.debugLine="getStage(o).RunMethod(\"setAlwaysOnTop\",Array(boo)";
...
_mainform = _form1;
 //BA.debugLineNum = 22;BA.debugLine="lis.Initialize";
_lis.Initialize();
 //BA.debugLineNum = 23;BA.debugLine="we.InitializeNewInstance(\"javafx.scene.web.WebEng";
_we.InitializeNewInstance("javafx.scene.web.WebEngine",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 24;BA.debugLine="doc.InitializeStatic(\"org.w3c.dom.Document\")";
_doc.InitializeStatic("org.w3c.dom.Document");
 //BA.debugLineNum = 25;BA.debugLine="MainForm.RootPane.LoadLayout(\"webengine\") 'Load t";
_mainform.getRootPane().LoadLayout(ba,"webengine");
 //BA.debugLineNum = 26;BA.debugLine="MainForm.Icon = fx.LoadImage(File.DirAssets,\"accu";
_mainform.setIcon((javafx.scene.image.Image)(_fx.LoadImage(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"accuweather.png").getObject()));
 //BA.debugLineNum = 27;BA.debugLine="temp = wv1";
_temp.setObject((java.lang.Object)(_wv1.getObject()));
 //BA.debugLineNum = 28;BA.debugLine="we = temp.RunMethod(\"getEngine\",Null)";
_we.setObject((java.lang.Object)(_temp.RunMethod("getEngine",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 29;BA.debugLine="wv1.Enabled = True";
_wv1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 30;BA.debugLine="wv1.Visible = True";
_wv1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 31;BA.debugLine="we.RunMethod(\"load\",Array As Object(startPage))";
_we.RunMethod("load",new Object[]{(Object)(_startpage)});
 //BA.debugLineNum = 32;BA.debugLine="navBar.TooltipText = \"[WEB}    http://website.com";
_navbar.setTooltipText("[WEB}    http://website.com"+anywheresoftware.b4a.keywords.Common.CRLF+"[FILES]  file:pathandname.ext");
 //BA.debugLineNum = 35;BA.debugLine="MainForm.SetFormStyle(\"DECORATED\")";
_mainform.SetFormStyle("DECORATED");
 //BA.debugLineNum = 36;BA.debugLine="MainForm.Show";
_mainform.Show();
 //BA.debugLineNum = 38;BA.debugLine="AlwaysOnTop(MainForm,True)";
_alwaysontop(_mainform,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 42;BA.debugLine="MainForm.WindowLeft = CheckMonitor.MaxX	- MainFor";
_mainform.setWindowLeft(_checkmonitor().getMaxX()-_mainform.getWidth()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (400)));
 //BA.debugLineNum = 43;BA.debugLine="MainForm.WindowTop = CheckMonitor.MaxY - MainForm";
...
public static String  _backbutton_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub BackButton_MouseClicked (EventData As MouseEve";
 //BA.debugLineNum = 46;BA.debugLine="we.RunMethod(\"executeScript\",Array As Object(\"his";
...
anywheresoftware.b4j.objects.JFX.ScreenWrapper _s = null;
 //BA.debugLineNum = 90;BA.debugLine="Sub CheckMonitor() As Screen";
 //BA.debugLineNum = 91;BA.debugLine="Try";
try { //BA.debugLineNum = 92;BA.debugLine="If fx.Screens.Size= 1 Then";
if (_fx.getScreens().getSize()==1) { 
 //BA.debugLineNum = 93;BA.debugLine="Dim SList As List = fx.Screens";
_slist = new anywheresoftware.b4a.objects.collections.List();
_slist = _fx.getScreens();
 //BA.debugLineNum = 94;BA.debugLine="Dim S As Screen = SList.Get(0)";
_s = new anywheresoftware.b4j.objects.JFX.ScreenWrapper();
_s.setObject((javafx.stage.Screen)(_slist.Get((int) (0))));
 //BA.debugLineNum = 96;BA.debugLine="Return S";
if (true) return _s;
 }else if(_fx.getScreens().getSize()>1) { 
 //BA.debugLineNum = 98;BA.debugLine="Dim SList As List = fx.Screens";
_slist = new anywheresoftware.b4a.objects.collections.List();
_slist = _fx.getScreens();
 //BA.debugLineNum = 99;BA.debugLine="Dim S As Screen = SList.Get(1)";
_s = new anywheresoftware.b4j.objects.JFX.ScreenWrapper();
_s.setObject((javafx.stage.Screen)(_slist.Get((int) (1))));
 //BA.debugLineNum = 101;BA.debugLine="Return S";
if (true) return _s;
 }else {
 //BA.debugLineNum = 103;BA.debugLine="Dim SList As List = fx.Screens";
_slist = new anywheresoftware.b4a.objects.collections.List();
_slist = _fx.getScreens();
 //BA.debugLineNum = 104;BA.debugLine="Dim S As Screen = SList.Get(0)";
_s = new anywheresoftware.b4j.objects.JFX.ScreenWrapper();
_s.setObject((javafx.stage.Screen)(_slist.Get((int) (0))));
 //BA.debugLineNum = 106;BA.debugLine="Return S";
if (true) return _s;
 };
 } 
       catch (Exception e16) {
			ba.setLastException(e16); //BA.debugLineNum = 109;BA.debugLine="Dim SList As List = fx.Screens";
_slist = new anywheresoftware.b4a.objects.collections.List();
_slist = _fx.getScreens();
 //BA.debugLineNum = 110;BA.debugLine="Dim S As Screen = SList.Get(0)";
_s = new anywheresoftware.b4j.objects.JFX.ScreenWrapper();
_s.setObject((javafx.stage.Screen)(_slist.Get((int) (0))));
 //BA.debugLineNum = 112;BA.debugLine="Return S";
if (true) return _s;
 };
...
String _s = "";
 //BA.debugLineNum = 77;BA.debugLine="Sub combo1_SelectedIndexChanged(Index As Int, Valu";
 //BA.debugLineNum = 78;BA.debugLine="Dim s As String = Value";
_s = BA.ObjectToString(_value);
 //BA.debugLineNum = 79;BA.debugLine="we.RunMethod(\"load\",Array As Object(s))";
...
public static String  _forwardbutton_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 48;BA.debugLine="Sub forwardButton_MouseClicked (EventData As Mouse";
 //BA.debugLineNum = 49;BA.debugLine="we.RunMethod(\"executeScript\",Array As Object(\"his";
...
public static anywheresoftware.b4j.object.JavaObject  _getstage(anywheresoftware.b4j.object.JavaObject _o) throws Exception{
 //BA.debugLineNum = 86;BA.debugLine="private Sub getStage(o As JavaObject) As JavaObjec";
 //BA.debugLineNum = 87;BA.debugLine="Return o.GetFieldJO(\"stage\")";
...
public static String  _gobutton_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Sub goButton_MouseClicked (EventData As MouseEvent";
 //BA.debugLineNum = 55;BA.debugLine="we.RunMethod(\"load\",Array As Object(navBar.Text))";
...
public static String  _homebutton_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 51;BA.debugLine="Sub homeButton_MouseClicked (EventData As MouseEve";
 //BA.debugLineNum = 52;BA.debugLine="we.RunMethod(\"load\",Array As Object(startPage))";
_we.RunMethod("load",new Object[]{(Object)(_startpage)});
...
_navbar = new anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper();
 //BA.debugLineNum = 12;BA.debugLine="Private startPage As String = \"https://ccatanaoan";
_startpage = "https://ccatanaoan.github.io/Outlook/";
 //BA.debugLineNum = 14;BA.debugLine="Private doc As JavaObject		' JavaObject library";
_doc = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 16;BA.debugLine="Private lis As List";
_lis = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 17;BA.debugLine="Private combo1 As ComboBox";
...
public static String  _wv1_pagefinished(String _url) throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub wv1_PageFinished (Url As String)";
