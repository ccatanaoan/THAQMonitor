...
public class gauge extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("cloyd.thaq.monitor", "cloyd.thaq.monitor.gauge", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", cloyd.thaq.monitor.gauge.class).invoke(this, new Object[] {null});
        else
...
public cloyd.thaq.monitor.gauge._gaugerange  _createrange(float _lowvalue,float _highvalue,int _color) throws Exception{
cloyd.thaq.monitor.gauge._gaugerange _r = null;
...
_r = new cloyd.thaq.monitor.gauge._gaugerange();
...
cloyd.thaq.monitor.gauge._gaugerange _gr = null;
...
_gr = (cloyd.thaq.monitor.gauge._gaugerange)(group9.Get(index9));
