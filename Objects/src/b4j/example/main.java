...
anywheresoftware.b4j.objects.JFX.ScreenWrapper _scr = null;
 ...
 //BA.debugLineNum = 173;BA.debugLine="Dim scr As Screen = fx.PrimaryScreen";
_scr = new anywheresoftware.b4j.objects.JFX.ScreenWrapper();
_scr = _fx.getPrimaryScreen();
 //BA.debugLineNum = 174;BA.debugLine="If isMaximized Then";
if (_ismaximized) { 
 //BA.debugLineNum = 175;BA.debugLine="MainForm.WindowLeft = f_X";
_mainform.setWindowLeft(_f_x);
 //BA.debugLineNum = 176;BA.debugLine="MainForm.WindowTop = f_Y";
_mainform.setWindowTop(_f_y);
 //BA.debugLineNum = 177;BA.debugLine="MainForm.WindowWidth = f_W";
_mainform.setWindowWidth(_f_w);
 //BA.debugLineNum = 178;BA.debugLine="MainForm.WindowHeight = f_H";
_mainform.setWindowHeight(_f_h);
 }else {
 //BA.debugLineNum = 180;BA.debugLine="f_X = MainForm.WindowLeft";
_f_x = _mainform.getWindowLeft();
 //BA.debugLineNum = 181;BA.debugLine="f_Y = MainForm.WindowTop";
_f_y = _mainform.getWindowTop();
 //BA.debugLineNum = 182;BA.debugLine="f_W = MainForm.WindowWidth";
_f_w = _mainform.getWindowWidth();
 //BA.debugLineNum = 183;BA.debugLine="f_H = MainForm.WindowHeight";
_f_h = _mainform.getWindowHeight();
 //BA.debugLineNum = 184;BA.debugLine="MainForm.WindowLeft = 0";
_mainform.setWindowLeft(0);
 //BA.debugLineNum = 185;BA.debugLine="MainForm.WindowTop = 0";
_mainform.setWindowTop(0);
 //BA.debugLineNum = 186;BA.debugLine="MainForm.WindowWidth = scr.MaxX";
_mainform.setWindowWidth(_scr.getMaxX());
 //BA.debugLineNum = 187;BA.debugLine="MainForm.WindowHeight = scr.MaxY + 40";
_mainform.setWindowHeight(_scr.getMaxY()+40);
 };
 //BA.debugLineNum = 189;BA.debugLine="isMaximized = Not(isMaximized)";
