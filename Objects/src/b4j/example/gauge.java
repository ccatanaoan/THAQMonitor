...
public class gauge extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.gauge", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.example.gauge.class).invoke(this, new Object[] {null});
        else
...
public anywheresoftware.b4j.objects.B4XCanvas _cvsgauge = null;
public anywheresoftware.b4j.objects.B4XCanvas _cvsindicator = null;
...
public anywheresoftware.b4j.objects.B4XViewWrapper _gaugepanel = null;
public anywheresoftware.b4j.objects.B4XViewWrapper _indicatorpanel = null;
...
public ResumableSub_AnimateValueTo(b4j.example.gauge parent,float _newvalue) {
this.parent = parent;
this._newvalue = _newvalue;
}
b4j.example.gauge parent;
float _newvalue;
long _n = 0L;
int _duration = 0;
float _start = 0f;
...
public String  _base_resize(double _width,double _height) throws Exception{
 ...
 //BA.debugLineNum = 86;BA.debugLine="mlbl.SetLayoutAnimated(0, 0, Height - mlbl.Height";
_mlbl.SetLayoutAnimated((int) (0),0,_height-_mlbl.getHeight()-__c.DipToCurrent((int) (5)),_width,_mlbl.getHeight());
 //BA.debugLineNum = 87;BA.debugLine="GaugePanel.SetLayoutAnimated(0, 0, 0, Width, Heig";
_gaugepanel.SetLayoutAnimated((int) (0),0,0,_width,_height);
 //BA.debugLineNum = 88;BA.debugLine="cvsGauge.Resize(Width, Height)";
_cvsgauge.Resize(_width,_height);
 //BA.debugLineNum = 89;BA.debugLine="IndicatorPanel.SetLayoutAnimated(0, 0, 0, Width,";
_indicatorpanel.SetLayoutAnimated((int) (0),0,0,_width,_height);
 //BA.debugLineNum = 90;BA.debugLine="cvsIndicator.Resize(Width, Height)";
_cvsindicator.Resize(_width,_height);
 //BA.debugLineNum = 92;BA.debugLine="DrawBackground";
_drawbackground();
...
_xui = new anywheresoftware.b4j.objects.B4XViewWrapper.XUI();
 //BA.debugLineNum = 18;BA.debugLine="Private cvsGauge, cvsIndicator As B4XCanvas";
_cvsgauge = new anywheresoftware.b4j.objects.B4XCanvas();
_cvsindicator = new anywheresoftware.b4j.objects.B4XCanvas();
 //BA.debugLineNum = 19;BA.debugLine="Private mlbl As B4XView";
_mlbl = new anywheresoftware.b4j.objects.B4XViewWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Type GaugeRange (LowValue As Float, HighValue As";
;
 //BA.debugLineNum = 21;BA.debugLine="Private mRanges As List";
_mranges = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 22;BA.debugLine="Private GaugePanel, IndicatorPanel As B4XView";
_gaugepanel = new anywheresoftware.b4j.objects.B4XViewWrapper();
_indicatorpanel = new anywheresoftware.b4j.objects.B4XViewWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private Radius, x, y As Float";
_radius = 0f;
_x = 0f;
_y = 0f;
 //BA.debugLineNum = 24;BA.debugLine="Private IndicatorLength As Int";
_indicatorlength = 0;
 //BA.debugLineNum = 25;BA.debugLine="Private CenterColor, IndicatorColor As Int";
_centercolor = 0;
_indicatorcolor = 0;
 //BA.debugLineNum = 26;BA.debugLine="Private MinValue, MaxValue As Float";
_minvalue = 0f;
_maxvalue = 0f;
 //BA.debugLineNum = 27;BA.debugLine="Private IndicatorBaseWidth As Float";
_indicatorbasewidth = 0f;
 //BA.debugLineNum = 28;BA.debugLine="Private mCurrentValue As Float = 50";
...
_half_circle = (int) (1);
_full_circle = (int) (2);
 //BA.debugLineNum = 32;BA.debugLine="Private GaugeType As Int";
_gaugetype = 0;
 //BA.debugLineNum = 33;BA.debugLine="Private AngleRange As Int";
_anglerange = 0;
 //BA.debugLineNum = 34;BA.debugLine="Private AngleOffset As Int";
_angleoffset = 0;
 //BA.debugLineNum = 35;BA.debugLine="Private BackgroundColor As Int";
_backgroundcolor = 0;
 //BA.debugLineNum = 36;BA.debugLine="End Sub";
return "";
}
public String  _configurefullcircle() throws Exception{
 //BA.debugLineNum = 138;BA.debugLine="Private Sub ConfigureFullCircle";
 //BA.debugLineNum = 139;BA.debugLine="Radius = Min(GaugePanel.Width, GaugePanel.Height)";
_radius = (float) (__c.Min(_gaugepanel.getWidth(),_gaugepanel.getHeight())/(double)2-__c.DipToCurrent((int) (3)));
 //BA.debugLineNum = 140;BA.debugLine="x = cvsGauge.TargetRect.CenterX";
_x = _cvsgauge.getTargetRect().getCenterX();
 //BA.debugLineNum = 141;BA.debugLine="y = cvsGauge.TargetRect.CenterY";
_y = _cvsgauge.getTargetRect().getCenterY();
 //BA.debugLineNum = 142;BA.debugLine="AngleOffset = 135";
_angleoffset = (int) (135);
 //BA.debugLineNum = 143;BA.debugLine="AngleRange = 270";
_anglerange = (int) (270);
 //BA.debugLineNum = 144;BA.debugLine="IndicatorBaseWidth = 6dip";
_indicatorbasewidth = (float) (__c.DipToCurrent((int) (6)));
 //BA.debugLineNum = 145;BA.debugLine="CenterColor = IndicatorColor";
_centercolor = _indicatorcolor;
 //BA.debugLineNum = 147;BA.debugLine="End Sub";
return "";
}
public String  _configurehalfcircle() throws Exception{
 //BA.debugLineNum = 129;BA.debugLine="Private Sub ConfigureHalfCircle";
 //BA.debugLineNum = 130;BA.debugLine="Radius = Min(GaugePanel.Width / 2, GaugePanel.Hei";
_radius = (float) (__c.Min(_gaugepanel.getWidth()/(double)2,_gaugepanel.getHeight()));
 //BA.debugLineNum = 131;BA.debugLine="x = cvsGauge.TargetRect.CenterX";
_x = _cvsgauge.getTargetRect().getCenterX();
 //BA.debugLineNum = 132;BA.debugLine="y = cvsGauge.TargetRect.Height";
_y = _cvsgauge.getTargetRect().getHeight();
 //BA.debugLineNum = 133;BA.debugLine="AngleOffset = 180";
_angleoffset = (int) (180);
 //BA.debugLineNum = 134;BA.debugLine="AngleRange = 180";
_anglerange = (int) (180);
 //BA.debugLineNum = 135;BA.debugLine="IndicatorBaseWidth = 20dip";
_indicatorbasewidth = (float) (__c.DipToCurrent((int) (20)));
 //BA.debugLineNum = 136;BA.debugLine="End Sub";
return "";
}
public b4j.example.gauge._gaugerange  _createrange(float _lowvalue,float _highvalue,int _color) throws Exception{
b4j.example.gauge._gaugerange _r = null;
...
_r = new b4j.example.gauge._gaugerange();
...
_fx = new anywheresoftware.b4j.objects.JFX();
 //BA.debugLineNum = 61;BA.debugLine="NativeFont = fx.LoadFont(File.DirAssets, \"crysta.";
_nativefont = (Object)(_fx.LoadFont(__c.File.getDirAssets(),"crysta.ttf",20).getObject());
 //BA.debugLineNum = 62;BA.debugLine="Lbl.Style = \"\"";
_lbl.setStyle("");
...
_mbase.AddView((javafx.scene.Node)(_gaugepanel.getObject()),0,0,_mbase.getWidth(),_mbase.getHeight());
 //BA.debugLineNum = 71;BA.debugLine="cvsGauge.Initialize(GaugePanel)";
_cvsgauge.Initialize(ba,_gaugepanel);
...
_mbase.AddView((javafx.scene.Node)(_indicatorpanel.getObject()),0,0,_mbase.getWidth(),_mbase.getHeight());
...
_mlbl.setObject((java.lang.Object)(_lbl.getObject()));
 //BA.debugLineNum = 76;BA.debugLine="mlbl.Font = xui.CreateFont(NativeFont, 30)";
_mlbl.setFont(_xui.CreateFont((javafx.scene.text.Font)(_nativefont),(float) (30)));
 //BA.debugLineNum = 77;BA.debugLine="mlbl.SetTextAlignment(\"CENTER\", \"CENTER\")";
_mlbl.SetTextAlignment("CENTER","CENTER");
 //BA.debugLineNum = 78;BA.debugLine="mlbl.TextColor = xui.Color_Black";
_mlbl.setTextColor(_xui.Color_Black);
 //BA.debugLineNum = 79;BA.debugLine="Dim lblheight As Float";
_lblheight = 0f;
 //BA.debugLineNum = 80;BA.debugLine="If PrefixText.Contains(CRLF) Then lblheight = 65d";
if (_prefixtext.contains(__c.CRLF)) { 
_lblheight = (float) (__c.DipToCurrent((int) (65)));}
else {
_lblheight = (float) (__c.DipToCurrent((int) (35)));};
 //BA.debugLineNum = 81;BA.debugLine="mBase.AddView(mlbl, 0, 0, 0, lblheight) 'label si";
_mbase.AddView((javafx.scene.Node)(_mlbl.getObject()),0,0,0,_lblheight);
 //BA.debugLineNum = 82;BA.debugLine="Base_Resize(mBase.Width, mBase.Height)";
_base_resize(_mbase.getWidth(),_mbase.getHeight());
 //BA.debugLineNum = 83;BA.debugLine="End Sub";
return "";
}
public String  _drawbackground() throws Exception{
b4j.example.gauge._gaugerange _gr = null;
anywheresoftware.b4j.objects.B4XCanvas.B4XPath _p = null;
float _startangle = 0f;
 //BA.debugLineNum = 101;BA.debugLine="Private Sub DrawBackground";
 //BA.debugLineNum = 102;BA.debugLine="cvsGauge.ClearRect(cvsGauge.TargetRect)";
_cvsgauge.ClearRect(_cvsgauge.getTargetRect());
 //BA.debugLineNum = 103;BA.debugLine="Select GaugeType";
switch (BA.switchObjectToInt(_gaugetype,_half_circle,_full_circle)) {
case 0: {
 //BA.debugLineNum = 105;BA.debugLine="ConfigureHalfCircle";
_configurehalfcircle();
 break; }
case 1: {
 //BA.debugLineNum = 107;BA.debugLine="ConfigureFullCircle";
_configurefullcircle();
 break; }
}
;
 //BA.debugLineNum = 109;BA.debugLine="cvsGauge.DrawCircle(x, y, Radius + 1dip, Backgrou";
_cvsgauge.DrawCircle(_x,_y,(float) (_radius+__c.DipToCurrent((int) (1))),_backgroundcolor,__c.True,(float) (0));
 //BA.debugLineNum = 110;BA.debugLine="For Each gr As GaugeRange In mRanges";
{
...
_gr = (b4j.example.gauge._gaugerange)(group9.Get(index9));
 //BA.debugLineNum = 111;BA.debugLine="Dim p As B4XPath";
_p = new anywheresoftware.b4j.objects.B4XCanvas.B4XPath();
 //BA.debugLineNum = 112;BA.debugLine="Dim StartAngle As Float = ValueToAngle(gr.LowVal";
_startangle = _valuetoangle(_gr.LowValue);
 //BA.debugLineNum = 113;BA.debugLine="p.InitializeArc(x, y, Radius, StartAngle, ValueT";
_p.InitializeArc(_x,_y,_radius,_startangle,(float) (_valuetoangle(_gr.HighValue)-_startangle));
 //BA.debugLineNum = 114;BA.debugLine="cvsGauge.ClipPath(p)";
_cvsgauge.ClipPath(_p);
 //BA.debugLineNum = 115;BA.debugLine="cvsGauge.DrawCircle(x, y, Radius, gr.Color, True";
_cvsgauge.DrawCircle(_x,_y,_radius,_gr.Color,__c.True,(float) (0));
 //BA.debugLineNum = 116;BA.debugLine="cvsGauge.RemoveClip";
_cvsgauge.RemoveClip();
 }
};
 //BA.debugLineNum = 118;BA.debugLine="cvsGauge.DrawCircle(x, y, Radius - IndicatorLengt";
_cvsgauge.DrawCircle(_x,_y,(float) (_radius-_indicatorlength),_backgroundcolor,__c.True,(float) (0));
 //BA.debugLineNum = 119;BA.debugLine="If GaugeType = FULL_CIRCLE And PrefixText <> \"\" T";
if (_gaugetype==_full_circle && (_prefixtext).equals("") == false) { 
 //BA.debugLineNum = 120;BA.debugLine="cvsGauge.DrawText(PrefixText, x, y - 30dip, xui.";
_cvsgauge.DrawText(_prefixtext,_x,_y-__c.DipToCurrent((int) (30)),_xui.CreateDefaultFont((float) (16)),_xui.Color_Black,BA.getEnumFromString(javafx.scene.text.TextAlignment.class,"CENTER"));
 //BA.debugLineNum = 122;BA.debugLine="cvsGauge.DrawCircle(x, y, Radius + 1dip, xui.Col";
_cvsgauge.DrawCircle(_x,_y,(float) (_radius+__c.DipToCurrent((int) (1))),_xui.Color_Gray,__c.False,(float) (__c.DipToCurrent((int) (1))));
 };
 //BA.debugLineNum = 124;BA.debugLine="DrawTicks";
_drawticks();
 //BA.debugLineNum = 125;BA.debugLine="cvsGauge.Invalidate";
_cvsgauge.Invalidate();
 //BA.debugLineNum = 126;BA.debugLine="DrawIndicator(mCurrentValue)";
...
String _s = "";
 //BA.debugLineNum = 172;BA.debugLine="Private Sub DrawIndicator (Value As Float)";
 //BA.debugLineNum = 173;BA.debugLine="cvsIndicator.ClearRect(cvsIndicator.TargetRect)";
_cvsindicator.ClearRect(_cvsindicator.getTargetRect());
 //BA.debugLineNum = 174;BA.debugLine="Dim angle As Float = ValueToAngle(Value)";
_angle = _valuetoangle(_value);
 //BA.debugLineNum = 175;BA.debugLine="Dim p As B4XPath";
_p = new anywheresoftware.b4j.objects.B4XCanvas.B4XPath();
 //BA.debugLineNum = 176;BA.debugLine="p.Initialize(x + IndicatorBaseWidth * SinD(angle)";
_p.Initialize((float) (_x+_indicatorbasewidth*__c.SinD(_angle)),(float) (_y-_indicatorbasewidth*__c.CosD(_angle)));
 //BA.debugLineNum = 177;BA.debugLine="Dim length As Float = Radius - 0.3 * IndicatorLen";
_length = (float) (_radius-0.3*_indicatorlength);
 //BA.debugLineNum = 178;BA.debugLine="p.LineTo(x + length * CosD(angle), y + length * S";
_p.LineTo((float) (_x+_length*__c.CosD(_angle)),(float) (_y+_length*__c.SinD(_angle)));
 //BA.debugLineNum = 179;BA.debugLine="p.LineTo(x - IndicatorBaseWidth * SinD(angle), y";
_p.LineTo((float) (_x-_indicatorbasewidth*__c.SinD(_angle)),(float) (_y+_indicatorbasewidth*__c.CosD(_angle)));
 //BA.debugLineNum = 180;BA.debugLine="cvsIndicator.ClipPath(p)";
_cvsindicator.ClipPath(_p);
 //BA.debugLineNum = 181;BA.debugLine="cvsIndicator.DrawRect(cvsIndicator.TargetRect, In";
_cvsindicator.DrawRect(_cvsindicator.getTargetRect(),_indicatorcolor,__c.True,(float) (0));
 //BA.debugLineNum = 182;BA.debugLine="cvsIndicator.RemoveClip";
_cvsindicator.RemoveClip();
 //BA.debugLineNum = 183;BA.debugLine="Dim CircleRadius As Float";
_circleradius = 0f;
 //BA.debugLineNum = 184;BA.debugLine="Dim s As String";
_s = "";
 //BA.debugLineNum = 185;BA.debugLine="If GaugeType = HALF_CIRCLE Then";
if (_gaugetype==_half_circle) { 
 //BA.debugLineNum = 186;BA.debugLine="s = PrefixText.ToUpperCase";
_s = _prefixtext.toUpperCase();
 //BA.debugLineNum = 187;BA.debugLine="CircleRadius =  Radius - IndicatorLength";
_circleradius = (float) (_radius-_indicatorlength);
 }else {
 //BA.debugLineNum = 189;BA.debugLine="CircleRadius = IndicatorBaseWidth";
_circleradius = _indicatorbasewidth;
 };
 //BA.debugLineNum = 191;BA.debugLine="cvsIndicator.DrawCircle(x, y, CircleRadius, Cente";
...
float _angle = 0f;
float _tr = 0f;
 //BA.debugLineNum = 149;BA.debugLine="Private Sub DrawTicks";
 //BA.debugLineNum = 150;BA.debugLine="Dim r1 As Int = Radius - 2dip";
_r1 = (int) (_radius-__c.DipToCurrent((int) (2)));
 //BA.debugLineNum = 151;BA.debugLine="Dim LongTick As Int = r1 - 7dip";
_longtick = (int) (_r1-__c.DipToCurrent((int) (7)));
 //BA.debugLineNum = 152;BA.debugLine="Dim ShortTick As Int = r1 - 5dip";
_shorttick = (int) (_r1-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 153;BA.debugLine="Dim NumberOfTicks As Int";
_numberofticks = 0;
 //BA.debugLineNum = 154;BA.debugLine="If GaugeType = HALF_CIRCLE Then NumberOfTicks = 1";
if (_gaugetype==_half_circle) { 
_numberofticks = (int) (10);}
else {
_numberofticks = (int) (20);};
 //BA.debugLineNum = 155;BA.debugLine="For i = 0 To NumberOfTicks";
{
final int step6 = 1;
...
_thickness = 0;
_r = 0;
 //BA.debugLineNum = 157;BA.debugLine="Dim angle As Float = i * AngleRange / NumberOfTi";
_angle = (float) (_i*_anglerange/(double)_numberofticks+_angleoffset);
 //BA.debugLineNum = 158;BA.debugLine="If i Mod 5 = 0 Then";
if (_i%5==0) { 
 //BA.debugLineNum = 159;BA.debugLine="thickness = 3dip";
_thickness = __c.DipToCurrent((int) (3));
 //BA.debugLineNum = 160;BA.debugLine="r = LongTick";
_r = _longtick;
 //BA.debugLineNum = 161;BA.debugLine="Dim tr As Float = r - 12dip";
_tr = (float) (_r-__c.DipToCurrent((int) (12)));
 //BA.debugLineNum = 162;BA.debugLine="cvsGauge.DrawTextRotated(NumberFormat(MinValue";
_cvsgauge.DrawTextRotated(__c.NumberFormat(_minvalue+_i/(double)_numberofticks*(_maxvalue-_minvalue),(int) (1),(int) (0)),_x+_tr*__c.CosD(_angle),_y+_tr*__c.SinD(_angle),_xui.CreateDefaultFont((float) (10)),_xui.Color_Black,BA.getEnumFromString(javafx.scene.text.TextAlignment.class,"CENTER"),(float) (_angle+90));
 }else {
 //BA.debugLineNum = 165;BA.debugLine="thickness = 1dip";
_thickness = __c.DipToCurrent((int) (1));
 //BA.debugLineNum = 166;BA.debugLine="r = ShortTick";
_r = _shorttick;
 };
 //BA.debugLineNum = 168;BA.debugLine="cvsGauge.DrawLine(x + r * CosD(angle), y + r * S";
...
public String  _setminandmax(float _newminvalue,float _newmaxvalue) throws Exception{
 //BA.debugLineNum = 95;BA.debugLine="Public Sub SetMinAndMax(NewMinValue As Float, NewM";
 //BA.debugLineNum = 96;BA.debugLine="MinValue = NewMinValue";
_minvalue = _newminvalue;
 //BA.debugLineNum = 97;BA.debugLine="MaxValue = NewMaxValue";
_maxvalue = _newmaxvalue;
 //BA.debugLineNum = 98;BA.debugLine="DrawBackground";
_drawbackground();
...
_r = (b4j.example.gauge._gaugerange)(group2.Get(index2));
