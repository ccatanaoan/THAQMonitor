...
_mlbl.SetLayoutAnimated((int) (0),0,_height-_mlbl.getHeight(),_width,_mlbl.getHeight());
...
if (_gaugetype==_full_circle && (_prefixtext).equals("") == false) { 
 //BA.debugLineNum = 120;BA.debugLine="cvsGauge.DrawText(PrefixText, x, y - 40dip, xui.";
_cvsgauge.DrawText(_prefixtext,_x,_y-__c.DipToCurrent((int) (40)),_xui.CreateDefaultFont((float) (12)),_xui.Color_Black,BA.getEnumFromString(javafx.scene.text.TextAlignment.class,"CENTER"));
